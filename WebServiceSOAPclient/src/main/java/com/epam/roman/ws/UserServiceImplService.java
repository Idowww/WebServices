 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://ws.roman.epam.com/", wsdlLocation = "http://localhost:9898/ws/user?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICEIMPLSERVICE_QNAME = new QName("http://ws.roman.epam.com/", "UserServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9898/ws/user?wsdl");
    ...
    public UserService getUserServiceImplPort() {
        return super.getPort(new QName("http://ws.roman.epam.com/", "UserServiceImplPort"), UserService.class);
    }
    ...
    public UserService getUserServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.roman.epam.com/", "UserServiceImplPort"), UserService.class, features);
    }
